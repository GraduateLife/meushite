...
export const GlareCard = ({
  ...
  return (
    <div
      ...
      className={cn(
        'duration-&lsqb;var(--duration)&rsqb; ease-&lsqb;var(--easing)&rsqb; delay-&lsqb;var(--delay)&rsqb; relative isolate w-[320px] transition-transform will-change-transform [aspect-ratio:17/21] [contain:layout_style] [perspective:600px]',
        sizeClassName
      )}
      ref={refElement}
      onPointerMove={(event) => {
